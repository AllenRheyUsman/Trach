...
const Home = () => {
  return (
    <div className='flex min-h-full justify-center sm:px-6 lg:px-8 '>
       <div className='flex-none w-[35%] bg-purple-200  self-center h-3/4 hover:bg-purple-300'>
      ...
      <div className='flex-none w-[35%] bg-white   self-center h-3/4'>
        <div className='p-10 h-full'>
          ...
          <h2 className='text-start text-3xl font-extrabold tracking-tight text-purple-900 '>
