...
import { Checkbox, FileInput, Label, Modal, Pagination, Radio } from 'flowbite-react';
...
const AuthForm = () => {
  ...
  const [activeTab, setActiveTab] = useState<InputType>('intro');
...
const totalTabs: InputType[] = ['intro', 'name', 'address', 'email', 'contact_number', 'queryone', 'company', 'lettings', 'portals', 'redress', 'password', 'outro'];
