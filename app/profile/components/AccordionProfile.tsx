    ...
    return (
      <Accordion collapseAll className='border-none w-full flex flex-wrap rounded-sm'>
        <Accordion.Panel className='border-none w-full px-0 mx-0 flex flex-wrap'>
          <Accordion.Title className='border-none hover:bg-purple-500 hover:text-white rounded-sm w-full px-0 mx-0 flex flex-wrap'>{title1}</Accordion.Title>
        ...
        <Accordion.Panel className='border-none'>
          <Accordion.Title className='border-none hover:bg-purple-500 hover:text-white rounded-sm'>{title2}</Accordion.Title>
